...
def main():
    ...
    """
    #### Descobreix amb aquesta app si estàs avançant pel camí correcte.
    
    L'objectiu de l'entrenament és fer-te millor. No importa si estàs entrenant per un 10k, la teva primera mitja marató o una cursa de 100km. Periòdicament, és important revisar si l'entrenament està funcionant per poder fer ajustos si és necessari.
    
    ### Com funciona?
    
    1. Conecta el teu perfil d'Strava.
    2. Selecciona el període de temps que vols analitzar.
    3. Analitza els resultats. Nomes tu pots arribar a la conclusió, ja que ets l'únic que coneix el teu context i el teu entrenament passat.
